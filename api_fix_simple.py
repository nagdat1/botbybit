...
def show_instructions():
    ...
    print("\nدليل الحصول على مفاتيح API من Bybit")
    print("=" * 50)
...
def add_api_keys_example():
    """مثال على إضافة مفاتيح API"""
    
    print("\nمثال على إضافة مفاتيح API:")
    print("=" * 40)
    
    print("\n1. استخدم الدالة التالية:")
...
if __name__ == "__main__":
    ...
    if current_status:
        ...
        # عرض التعليمات
        show_instructions()
        add_api_keys_example()
        
        print("\n" + "=" * 60)
        print("بعد الحصول على مفاتيح API:")
        print("=" * 60)
        print("1. استخدم add_api_keys_to_system() لإضافة المفاتيح")
        print("2. استخدم test_api_keys_comprehensive() لاختبار المفاتيح")
        print("3. النظام سيعمل بشكل مثالي!")
