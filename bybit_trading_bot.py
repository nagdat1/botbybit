...
✅ يغلق أي صفقة مفتوحة لهذا الرمز
...
✅ يفتح صفقة شراء بالرافعة

4️⃣ إغلاق لونج (CLOSE_LONG)
{
  "signal": "close_long",
  "symbol": "BTCUSDT"
}
...
✅ يفتح صفقة بيع بالرافعة

6️⃣ إغلاق شورت (CLOSE_SHORT)
{
  "signal": "close_short",
  "symbol": "ETHUSDT"
}
...
📌 عند الفتح (buy/long/short):
• ينفذ بسعر السوق الحالي
• يحسب الكمية من إعداداتك
• يحفظ الصفقة تلقائياً

📌 عند الإغلاق (sell/close_long/close_short):
• يبحث عن صفقة مفتوحة لنفس الرمز
• يغلقها فوراً بسعر السوق
• إذا لم توجد صفقة = تجاهل

━━━━━━━━━━━━━

⚠️ مهم:
• السعر غير مطلوب - تنفيذ فوري
• signal و symbol فقط مطلوبان
• معرف تلقائي لكل إشارة
