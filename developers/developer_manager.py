    ...
    def reset_all_users_data(self, developer_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                # ⚠️ لا نعيد تحميل المستخدمين! قاعدة البيانات يجب أن تبقى فارغة
                # المستخدمون الجدد سيتم إنشاؤهم عند استخدام /start فقط
                
                logger.warning(f"🔄 المطور {developer_id} أعاد تعيين المشروع بالكامل ({user_count} مستخدم محذوف)")
                return {
                    'success': True,
                    'message': f'✅ تم إعادة تعيين المشروع بالكامل\n\n🗑️ تم حذف:\n• {user_count} مستخدم\n• قاعدة البيانات بالكامل\n• جميع البيانات من الذاكرة\n• جميع الحسابات الحقيقية\n\n⚠️ قاعدة البيانات الآن فارغة تماماً\n💡 المستخدمون الجدد سيبدأون من الصفر عند /start',
